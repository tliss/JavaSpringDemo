package com.taylorliss.servlet.demo;
...
import com.taylorliss.service.demo.WelcomeService;
...
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Taylor Liss");
